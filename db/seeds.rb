...
LOCAL_CITIES = ['Los Angeles', 'San Diego', 'San Jose', "San Francisco", "Fresno", "Sacramento", "Long Beach", "Oakland", "Fresno", "Fremont", "Bakersfield", "Santa Ana",
                "Riverside", "Chula Vista", "Stockton", "Irvine", "San Bernadino", "Modesto", "Oxnard", "Fontana"]
